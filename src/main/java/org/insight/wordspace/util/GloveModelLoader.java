...
public class GloveModelLoader {
  ...
  public static W2vSpace load(String vocabFile, String word2vecModel, int vecSize, boolean withContexts, boolean bias) {
    ...
    try {
      ...
      BufferedInputStream bufIn = new BufferedInputStream(fs, 131072); // 128KB
                                                                       // Buffer
